/**
 * Class implementing the Runnable interface for withdrawing money from a bank account - thread synchronization.
 */
public class WithdrawSynchronizedThread implements Runnable {
     ...
     */
    public WithdrawSynchronizedThread(SharedBank bank, int withdrawalAmount) {
        this.bank = bank;
